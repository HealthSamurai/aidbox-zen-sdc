...
export interface ConceptMapRuleElement {
    code?: string;
    target?: ConceptMapRuleElementTarget[];
}

export interface ConceptMapRuleElementTarget {
    code?: string;
    comment?: string;
    display?: string;
    equivalence?: string;
...
export interface IdentityProvider {
    ...
    toScim?: any;
    type?: 'aidbox' | 'github' | 'google' | 'OIDC' | 'OAuth' | 'az-dev' | 'yandex' | 'okta';
